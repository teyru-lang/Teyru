...
var nativeTable = map[string]nativeFn{
	...
	// ---- Character
	// Classification and the case mappings are Unicode 15.0's: the runtime
	// answers from the generated tables in tyrt_unicode.c, so each helper takes
	// a code point -- an int, which is what Java's own methods take. The char
	// overloads in lib/04_boxing.teyru are written in Teyru and call these.
	"Character.isDigit(I)":         {fn: "ty_is_digit"},
	"Character.isLetter(I)":        {fn: "ty_is_letter"},
	"Character.isLetterOrDigit(I)": {fn: "ty_is_letter_or_digit"},
	"Character.isAlphabetic(I)":    {fn: "ty_is_alphabetic"},
	"Character.isUpperCase(I)":     {fn: "ty_is_upper_case"},
	"Character.isLowerCase(I)":     {fn: "ty_is_lower_case"},
	"Character.isTitleCase(I)":     {fn: "ty_is_title_case"},
	"Character.isWhitespace(I)":    {fn: "ty_is_whitespace"},
	"Character.isSpaceChar(I)":     {fn: "ty_is_space_char"},
	"Character.isDefined(I)":       {fn: "ty_is_defined"},
	"Character.getType(I)":         {fn: "ty_char_type"},
	"Character.toUpperCase(I)":     {fn: "ty_char_upper"},
	"Character.toLowerCase(I)":     {fn: "ty_char_lower"},
	"Character.toTitleCase(I)":     {fn: "ty_char_title"},
	"Character.getNumericValue(I)": {fn: "ty_char_numeric"},
	"Character.digit(I,I)":         {fn: "ty_char_digit"},
	...
	"StringBuilder.replace(I,I,String)": {fn: "ty_sb_replace", recv: "void*"},
	...
	"StringBuffer.replace(I,I,String)": {fn: "ty_sb_replace", recv: "void*"},
